...
<c:url var="formlUrl" value="${prefix}/report/report101B.html"/>
...
<section class="content-header">
    <ol class="breadcrumb">
        ...
        <li class="active"><fmt:message key="report101B.title_page"/></li>
    </ol>
        ...
        <div class="col-xs-12">
            <div id="content" class="box box-solid box-primary">
                <div class="box-header">
                    <h3 class="box-title"><fmt:message key="report101B.title_page"/></h3>
