...
<c:url var="formlUrl" value="${prefix}/report/report102.html"/>
    ...
    <div class="container">
        <form:form commandName="item" action="${formlUrl}" id="listForm" method="post" autocomplete="off" name="listForm" cssClass="form-horizontal">
            <section class="content-header">
                <h4>
                    <fmt:message key="label.report102.title"/>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><fmt:message key="label.report102.title"/></li>
                </ol>
                    ...
                    <div class="col-xs-12">
                        <div id="content" class="box box-solid box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><fmt:message key="label.report102.title"/></h3>
                            </div>
                            ...
                            <div class="box-body">
                                <display:table name="items.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                    ...
                                    <display:column headerClass="table_header nowrap" sortable="false" titleKey="label.nhathau.tengoithau" class="nowrap" style="width: 12%;">
                                        <str:truncateNicely upper="25">${tableList.goiThau.tengoithau}</str:truncateNicely>
                                    </display:column>
                                    ...
                                    <display:column headerClass="table_header nowrap" sortable="false" property="thoiGianLap" titleKey="label.hinhThuc.thoiGianLap" class="nowrap" style="width: 12%;" />
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#report_menu', '#report102_menu');
