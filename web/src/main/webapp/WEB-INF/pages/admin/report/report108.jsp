...
<c:url var="formlUrl" value="${prefix}/report/report108.html"/>
    ...
    <div class="container">
        <form:form commandName="item" action="${formlUrl}" id="listForm" method="post" autocomplete="off" name="listForm" cssClass="form-horizontal">
            <section class="content-header">
                <h4>
                    <fmt:message key="label.report108.title"/>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><fmt:message key="label.report108.title"/></li>
                </ol>
                    ...
                    <div class="col-xs-12">
                        <div id="content" class="box box-solid box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><fmt:message key="label.report108.title"/></h3>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        setActiveMenu4Admin('#report_menu', '#report108_menu');
    ...
    function rebuildTableHeaders(){
        ...
        $('#tableList thead').html("<tr>" +
                ...
                "<th rowspan='2' class='table_header_center '><fmt:message key='label.nhathau.tengoithau'/></th>" +
                "<th rowspan='2' class='table_header_center '><fmt:message key='label.hinhThuc.tenHinhThuc'/></th>" +
                "<th rowspan='2' class='table_header_center '><fmt:message key='label.tienDo.ngayQDDAPA'/></th>" +
                "<th colspan='2' class='table_header_center '><fmt:message key='label.tienDo.ngayTrinhHs'/></th>" +
                "<th rowspan='2' class='table_header_center '><fmt:message key='label.hinhThuc.thoiGianLap'/></th>" +
                "<th rowspan='2' class='table_header_center '><fmt:message key='label.hinhThuc.nvChuTri'/></th>" +
                "</tr>" +
                "<tr>" +
                "<th class='table_header_center '><fmt:message key="label.ngay"/></th>" +
                "<th class='table_header_center '><fmt:message key="tiendo.label.so"/></th>" +
        "</tr>");
    }
</script>
</body>
