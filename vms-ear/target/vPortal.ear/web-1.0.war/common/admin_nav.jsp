...
<nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;"
    ...
    <div class="sidebar-collapse menu-scroll">
        <ul id="side-menu" class="nav">
            ...
            <li id="roleTab"><a href="/portal/admin/role/list.html"><i class="fa fa-users">
                <div class="icon-bg bg-orange"></div>
            </i><span class="menu-title"><fmt:message key="role.manager.title"/></span></a></li>

            <li><a href="/portal/admin/authoringtemplate/list.html"><i class="fa fa-users">
                <div class="icon-bg bg-orange"></div>
            </i><span class="menu-title"><fmt:message key="authoringtemplate.manager.title"/></span></a></li>
